...
<a href="https://github.com/wayy-digital">
  <img src="https://i.postimg.cc/Xqt0vdbJ/IMG-3368.jpg" width="100%" alt="Банер Adionov" style="border-radius: 20px !important;"/>
</a>
...
<div align="justify">
  <h3>Привіт! Я Adionov</h3>
  > Вдень я роблю вигляд, що розумію всесвіт, нейромережі та лінійну алгебру. Вночі — пишу Python-скрипти, щоб автоматизувати власне життя й остаточно уникнути реальної роботи.

### ⚡ Технічний стан:
* 🧠 **Напрямок:** AI & Data Science (читаю документацію, поки не вигорю).
* 👁️ **Естетика:** Маю нездорову любов до мінімалістичних темних інтерфейсів. Світла тема — це порушення прав людини.
* 🐍 **Суперсила:** Витратити 4 години на Python-автоматизацію задачі, яка займає 5 хвилин вручну.

### 🎮 Поза терміналом (коли не коджу):
* 🚁 **GTA V:** Професійний тестувальник гравітації (регулярно розбиваю гелікоптери).
* 🏰 **Clash of Clans:** CEO власного села. Керую економікою так, ніби це компанія зі списку Fortune 500 під постійним стресом та загрозою рейдерського захоплення.
  <br><br>
...
<br>
  ...
  > Проєкти тримаю приватними, тому що мені соромно за свій код.
...
<div align="center">
  ...
  <br>
  <a href="https://github.com/wayy-digital"><img src="https://img.shields.io/badge/GitHub-000000?style=for-the-badge&logo=github&logoColor=white"></a>
  &nbsp;
  <a href="mailto:mstebnovskij666@gmail.com"><img src="https://img.shields.io/badge/Gmail-000000?style=for-the-badge&logo=gmail&logoColor=white"></a>
  &nbsp;
</div>

<br>

> Код ніколи не буває завершеним. Він лише стає трохи менш жахливим з часом.

> Кожен мій commit — це маленьке відчайдушне вибачення перед собою в майбутньому. Одного дня я повернусь до цього кодбейсу, подивлюсь на ці спагеті-коди й задамся питанням, хто взагалі дозволив мені підходити до клавіатури.
...
<div align="center">
  ...
  <table align="center" style="background: transparent; border: none;">
    ...
    <tr>
      <td align="right" valign="middle" style="padding-right: 20px;">
        <strong>Бекенд та база даних</strong>
      </td>
      <td align="left" valign="middle">
    ...
    <tr>
      <td align="right" valign="middle" style="padding-right: 20px;">
        <strong>DevOps та інструменти</strong>
      </td>
      <td align="left" valign="middle">
